...
def plot_impairment_movie(shp, case, impairment, run_file):
    """ 
    ...
    output_directory = processed_netcdf_dir/run_type/'movies'/'impairment'/impaired_txt
    ...
    if os.path.exists(output_directory)==False:
        ...
        if os.path.exists(
                processed_netcdf_dir/run_type/'movies'/'impairment')==False:
            if os.path.exists(processed_netcdf_dir/run_type/'movies') == False:
                os.makedirs(
                    ...
                    exist_ok=True)
                os.makedirs(
                    processed_netcdf_dir/run_type/'movies'/'impairment',
                    mode=0o777,
                    exist_ok=True)
                os.makedirs(
                    processed_netcdf_dir/run_type/'movies'/'impairment'/impaired_txt,
                    mode=0o777,
                    exist_ok=True)
            else:
                os.makedirs(
    ...
    for day in range(ndays):
        ...
        output_file = output_directory/f'{case}_{run_tag}_impairment_{impaired_txt}_{model_day}.png'
...
if __name__=='__main__':
    ...
    plot_impairment_movie(shp, case, float(impairment), run_file)
