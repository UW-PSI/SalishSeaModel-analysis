...
import sys
from create_TS_inlet_netcdf import create_TS_inlet_netcdf
"""
...
for inlet in ["Sinclair Inlet"]: #["Bellingham Bay", "Case Inlet", "Sinclair Inlet"]:
    ...
    for variable in ['zeta']: #[*ssm_nc['label_dict']]:
        print("******",inlet,": ",variable,"******")
        start_time = process_time()
        create_TS_inlet_netcdf(
            nc_file, 
            shp, 
            output_netcdf_dir, 
            variable, 
