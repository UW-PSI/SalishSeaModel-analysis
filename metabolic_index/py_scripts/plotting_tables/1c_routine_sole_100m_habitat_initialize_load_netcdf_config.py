#!/usr/bin/env python
"""
Initialize and Load NetCDF Configuration - Sole 100m Habitat
Module 1 of 14 in the analysis pipeline
Modified: 2026-02-12 - Changed from crab (80m) to sole (100m depth limit)
"""
...
#
# **Current Configuration:** Sole - 100m depth limit, bottom layer only
# **Changes from Crab:** Updated depth from 80m to 100m (see line ~435)
#
# ============================================================================
...
taxa = "sole"  # Changed from "crab" - 2026-02-12 
#taxa = "sculpin"  
#taxa = "sole"
